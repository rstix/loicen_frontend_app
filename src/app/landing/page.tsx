    ...
    <div className={roboto.className}>
      <div className="bg-white text-gray-very_dark">
        <div className="flex flex-1 flex-col align-middle justify-center items-center max-w-[1560px] mx-auto">
          <div className="md:px-2 sm:px-4 z-10">
            <nav className="flex w-full justify-between text-white p-3 px-5 bg-gray-very_dark border border-gray mt-2 rounded-[15px]">
              ...
              <div className="flex gap-6 align-middle">
                ...
                <button className="bg-gray-light p-1 px-2 text-gray-very_dark rounded-md font-semibold">
                  Contact sales
                </button>
              </div>
            </nav>
            ...
            <div className="mt-[160px]  max-w-[1250px] flex  items-center flex-col">
              <div className="flex justify-center flex-col items-center">
                <h1 className="text-[62px] font-bold leading-tight  text-gray-very_dark mx-6 text-center">
                  Supercharge your legal research, with the power of AI.
                </h1>
                <h4 className="text-[24px] text-gray-very_dark leading-tight my-6 mx-40 text-center">
              ...
              <div className="flex flex-col mt-[120px]">
                ...
                <h4 className="text-[24px] leading-tight mt-6 mb-12">
                ...
                <div className="flex flex-col gap-10">
                  <div className="flex gap-10">
                    <div className="basis-3/5 flex flex-col justify-evenly bg-gray-very_light p-10 rounded-lg">
                    ...
                    <div className="basis-2/5 flex flex-col bg-gray-very_light p-10 rounded-xl">
                      ...
                      <h5 className="text-[32px] font-semibold">Stay secure</h5>
                      <p className="text-gray">
                  ...
                  <div className="flex gap-20 justify-evenly bg-gray-very_light p-10 rounded-xl">
                    <Image
                      src="/img/working_together.svg"
                      width={250}
                      height={250}
                      alt="search box"
                      className="basis-1/2 max-w-[240px]"
                    />
              ...
              <div className="flex flex-col mt-[100px]">
                ...
                <div className="flex gap-6  mt-[40px]">
                  <div className="basis-1/3 text-[24px] flex flex-col bg-gray-very_light p-10 rounded-lg">
                    {/* <div className="flex justify-center my-12">
                    <Image
                      src="/img/search_box.png"
                      width={650}
              ...
              <div className="flex items-center mt-[100px] gap-6 bg-gray-very_light p-10 rounded-lg">
                <div className="basis-1/2">
                  <h4 className="text-[36px] font-semibold leading-tight">
                ...
                <div className="basis-1/2">
                  <form action={onSubmit} className="relative">
                    ...
                    <button
                      type="submit"
                      className="absolute top-1/2 -translate-y-1/2 right-1 bg-gray-very_dark p-2 px-3 text-white rounded-md font-semibold"
                    >
                      Contact sales
                    </button>
                  </form>
