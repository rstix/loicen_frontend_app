  ...
  return (
    <div className="text-sm text-gray-darker">
      <div className="flex justify-end gap-2">
        <div
          className="flex w-max items-center gap-2 cursor-pointer border bg-gray-dark  transition border-gray rounded py-[0px] px-2 hover:text-gray-light  hover:bg-gray"
